...
class ProductQuotationAdapter(var dataSet: ArrayList<Product>): RecyclerView.Adapter<ProductQuotationAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            cardAvailable = itemView.findViewById(R.id.cardAvailable)
