...
import com.sys4soft.deldia.web.PrinterCommands
...
//            val permission7 = ContextCompat.checkSelfPermission(this, Manifest.permission.MANAGE_EXTERNAL_STORAGE)
    ...
    private fun showOperation(){
        ...
        textTicketPart1 += "DISTRIBUCIONES S.A.C. \n"
        ...
        for (item in operation.details){
            ...
            textTicketPart4 += "${item.quantity}  x  ${dfZero.format(item.price)}  =  ${dfZero.format(item.subtotal)} \n"
        }
        ...
        textTicketPart8 += "https://www.tuf4ct.com/cpe\n"
...
//                outputStream!!.write(format)
            ...
            outputStream!!.write("DISTRIBUCIONES S.A.C. \n".toByteArray())
            ...
            for (item in operation.details){
                ...
                outputStream!!.write("${item.quantity}  x  ${dfZero.format(item.price)}  =  ${dfZero.format(item.subtotal)} \n".toByteArray())
            }
...
//                outputStream!!.write(format)
            ...
            outputStream!!.write("https://www.tuf4ct.com/cpe\n".toByteArray())
